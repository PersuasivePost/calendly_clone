...
export default function PrivateNavBar() {
  ...
  return (
    <nav className="flex justify-between items-center fixed z-50 w-full h-28 bg-gray-200 px-10 gap-4 shadow-2xl mb-28">
      ...
      >
        <Image src="/assets/logo.svg" width={60} height={60} alt="lets talk" />
      </Link>

      {/* nav links */}
      <section className="sticky top-0 justify-between text-black">
          ...
          {PrivateNavLinks.map((item) => {
            ...
            return (
              ...
              >
                ...
                <p className={cn("text-1g font-semibold max-lg:hidden")}>
                  {item.label}
                </p>
              </Link>
            );
